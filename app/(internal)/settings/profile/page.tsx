...
import { ProfileToolbar } from '@app/presentation/components/internal/shared/profile';
import { ProfileView } from '@app/presentation/components/internal/shared/profile';
...
export default async function ProfilePage() {
  ...
  return (
    <>
      ...
      <ProfileView initialUser={UserMapper.fromDomainToDto(user) as UserDto} />
    </>
  );
}

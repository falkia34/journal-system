...
import type { UserDto } from '@app/infrastructure/dtos';
      ...
      <Box component="section" className="mb-4 w-full px-6">
        <Container maxWidth={false} className="max-w-2xl p-0">
          ...
          <Grid container spacing={0.5}>
            ...
            <Grid size={12}>
              <ViewTile title="Email" subtitle={user.email} position="middle" />
            </Grid>
            <Grid size={12}>
              <ViewTile title="Roles" subtitle={rolesDisplay} position="bottom" />
            </Grid>
          </Grid>
        </Container>
      </Box>

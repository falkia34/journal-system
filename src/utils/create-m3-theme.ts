...
export function createM3Theme({
              ...
              },
              {
                ...
                style: {
                  ...
                  '&:hover': {
                    ...
                    ...theme.applyStyles('dark', {
                      background: theme.lighten(theme.vars.palette.secondaryContainer.main, 0.08),
                    }),
                  },
                },
              },
              ...
              },
              {
                ...
                style: {
                  ...
                  '&:hover': {
                    ...
                    ...theme.applyStyles('dark', {
                      background: theme.lighten(theme.vars.palette.tertiaryContainer.main, 0.08),
                    }),
                  },
                },
              },
  ...
  return createTheme(base, themeOptions ?? {});
}
